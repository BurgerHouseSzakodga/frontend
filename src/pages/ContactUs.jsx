    ...
    return (
        <div>
            <div className="contact-us">
                <h1>Kapcsolat</h1>
                <p>Ha bármilyen kérdése van, vagy szeretne többet megtudni rólunk, ne habozzon kapcsolatba lépni velünk!</p>
                <div className="contact-info">
                    <p><strong>Cím:</strong> Budapest, 1234 Valahol utca 12.</p>
